...
def main():
    ...
    if st.button('Test Case 1 (Cancelled)'):
        ...
        prediction = predict_booking_status(test_case_1)  # Use the correct prediction function
    ...
    if st.button('Test Case 2 (Not Cancelled)'):
        ...
        prediction = predict_booking_status(test_case_2)  # Use the correct prediction function
